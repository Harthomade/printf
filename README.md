_printf()
The _printf project is a collaboration between Akinyoola Akinyoola and Temitope Adeyinka, students of Software Engineering cohort 11 at ALX Africa. The function named "_printf" imitates the actual "printf" function located in the stdio.h library of C programming language. It contains some of the basic features and functions found in the manual 3 of "printf".
